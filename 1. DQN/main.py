...
def init_parameters():
    ...
    parser.add_argument("--epsilon_start", type=float, default=1, help="Starting value of epsilon for exploration (higher means more exploration)")
    parser.add_argument("--epsilon_end", type=float, default=0.02, help="Final value of epsilon after decay (lower means more exploitation)")
    ...
    parser.add_argument("--interval", type=int, default=100, help="Number of steps between target Q-network updates")
...
if __name__ == '__main__':
    ...
    # save model
    save_model(os.path.dirname(os.path.realpath(__file__)), agent.q_net.state_dict(), 'dqn_q')
    # plot reward curve
