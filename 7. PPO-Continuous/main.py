...
def init_parameters():
    ...
    parser.add_argument("--Lambda", type=float, default=0.9, help="Decay factor in GAE (Generalized Advantage Estimation)")
    parser.add_argument("--epoch", type=int, default=20, help="Training times per trajectory")
    parser.add_argument("--eps", type=float, default=0.2, help="Clipping range")
    parser.add_argument("--entropy_coef", type=float, default=0.01, help="Weight of the entropy in the control policy, helping balance exploration and exploitation")
